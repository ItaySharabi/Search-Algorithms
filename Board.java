...
public class Board {
    ...
    private List<Marble> movableMarbles;
    ...
    public Board(String[][] board, Tile operated, Direction direction) {
        if (! (null == operated || null == direction)) {
            int i = operated.getI(), j = operated.getJ();
            ...
            this.operatedMarble = new Marble(operated.getTag(), i, j);
            this.operatedMarbleDirection = direction;
            movableMarbles = new ArrayList<>();
            setGameBoard(board);
        }
    }
